...
def extract_features(data, in_feas, epochs, topn=100):
    ...
    topn_omics_1.to_csv(f'result/species_{disease_name}_1.csv', header=True, index=False)
    topn_omics_2.to_csv(f'result/marker_{disease_name}_2.csv', header=True, index=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path1', '-p1', type=str, required=True, help='The species abundance file name.')
    parser.add_argument('--path2', '-p2', type=str, required=True, help='The strain marker file name.')
    ...
    parser.add_argument('--epoch', '-e', type=int, default=500, help='Training epochs, default: 500.')
